...
class UBXUNDOREDOMANAGER_API CActionBlockGroupManager
{
public:
...
public:
    ...
    * 作者: hwx
    */
    virtual void cloneData(CActionBlockGroupManager *pActionGroupData);
...
//    bool IsExistBlockData(int nID);
    ...
    * 作者: hwx
    */
    int indexAt(CActionBlockData *pBlockData);
    ...
    * 作者: ZDJ
    */
    float GetActionStartTimeByIndex(int nActionIndex);
    ...
    * 作者: ZDJ
    */
    void SetExtBlockData(int nLen, const char* pData);
