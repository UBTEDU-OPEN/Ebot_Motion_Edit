...
class CUBXMotionEditorLayout : public QWidget,public IActionLayerManager,public ILayerManager_Event/*, public ILayerControlEvent*/
{
    Q_OBJECT
...
public:
    ...
    virtual void ActionLayerManager_SetTabWidgetTabText(const QString &sFile) override;
