    ...
    m_pMainLayer(NULL)
{
    ...
    QString sResDir;
#ifdef Q_OS_MAC
    sResDir = "/../res/UBXMotionEditor.rcc";
#else
    sResDir = "/res/UBXMotionEditor.rcc";
#endif
...
void CUBXMotionEditorLayout::ActionLayerManager_SetTabWidgetTabText(const QString &sFile)
{
    if (m_pMainLayer)
    {
        m_pMainLayer->LayerManager_setTabWidgetTabText(sFile);
    }
}
