...
public:
    ...
    virtual void ILayerManager_SetActionBlockDataManager(CActionBlockDataManager* pManager, int nCurrentGroupID,int nCurrentActionID) = 0;
...
public:
    ...
    virtual void LayerManager_setTabWidgetTabText(const QString &sFile) = 0;
