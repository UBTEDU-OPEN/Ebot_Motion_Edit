#ifndef _IACTIONLAYERMANAGER_H_
#define _IACTIONLAYERMANAGER_H_
...
public:
    ...
    virtual void ActionLayerManager_SetTabWidgetTabText(const QString &sFile) = 0;
};
