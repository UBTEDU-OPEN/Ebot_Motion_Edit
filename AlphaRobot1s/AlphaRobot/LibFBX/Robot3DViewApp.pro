#-------------------------------------------------
#
# Project created by QtCreator 2015-11-03T16:05:53
#
#-------------------------------------------------
...
macx: LIBS += -L$$PWD/ -lfbxsdk

INCLUDEPATH += $$PWD/
DEPENDPATH += $$PWD/

macx: PRE_TARGETDEPS += $$PWD/libfbxsdk.a

macx: LIBS += -L$$PWD/ -lGLEW64

INCLUDEPATH += $$PWD/
DEPENDPATH += $$PWD/

macx: PRE_TARGETDEPS += $$PWD/libGLEW64.a


GLUT = -F/Library/Frameworks
QMAKE_CFLAGS += $$GLUT
QMAKE_CXXFLAGS += $$GLUT
QMAKE_OBJECTIVE_CXXFLAGS += $$GLUT
LIBS += $$GLUT
LIBS += -framework GLUT
