...
{
    FILE * lFile = NULL;
    QString strRobotFile = CConfigs::getLocalRobotPath(FBX_ASCII_TEXTURE);

    QByteArray baFBX = strRobotFile.toLatin1();
    char *szRobotFileName =baFBX.data();
    FBXSDK_fopen(lFile, szRobotFileName, "rb");
    if (lFile == NULL)
    {
