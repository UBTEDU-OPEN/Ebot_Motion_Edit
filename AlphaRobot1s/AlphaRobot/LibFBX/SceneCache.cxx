...
void VBOMesh::Draw(int pMaterialIndex, ShadingMode pShadingMode) const
{
    ...
    if ( pShadingMode == SHADING_MODE_SHADED || pShadingMode == SHADING_MODE_DEFAULTCOLOR)
    {
...
void VBOMesh::BeginDraw(ShadingMode pShadingMode) const
{
    ...
    // Set normal array.
    if (mHasNormal && (pShadingMode == SHADING_MODE_SHADED || pShadingMode == SHADING_MODE_DEFAULTCOLOR))
    {
        glBindBuffer(GL_ARRAY_BUFFER, mVBONames[NORMAL_VBO]);
    ...
    // Set UV array.
    if (mHasUV && (pShadingMode == SHADING_MODE_SHADED || pShadingMode == SHADING_MODE_DEFAULTCOLOR))
    {
        glBindBuffer(GL_ARRAY_BUFFER, mVBONames[UV_VBO]);
