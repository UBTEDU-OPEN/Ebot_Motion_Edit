...
DefTreeWidget::DefTreeWidget(QWidget *parent):
    CTemplateActTreeWdg(parent)
{
    setTemplateDir(CConfigs::getLocalDefaultTemplateDir());
}

DefTreeWidget::~DefTreeWidget()
{

}

//void DefTreeWidget::mouseMoveEvent(QMouseEvent *event)
//{
...
//void DefTreeWidget::mousePressEvent(QMouseEvent *event)
//{
...
//bool DefTreeWidget::ParseData(char *pData, int nLens)
//{
//    int nTotalLen = 0;
