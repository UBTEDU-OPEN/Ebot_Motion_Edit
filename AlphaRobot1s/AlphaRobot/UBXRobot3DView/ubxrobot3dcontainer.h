...
class UBXROBOT3DVIEWSHARED_EXPORT UBXRobot3DContainer : public UBXWidget, public IUBXRobot3DView, public IUBXRobotViewControlNotify
{
    Q_OBJECT
...
public:
    ...
    virtual void Set3DViewRotationSmooth(int nID, float fRot, int nTime = 200);
...
public:
    ...
    //获取各舵机角度
    virtual bool getMotorInfo(QMap<int, int> &motorInfos);
    //获取各舵机角度
    virtual bool GetMotorDatas(char** pData, int& nLen);
    //设置各舵机角度
